...
from scraper.client import USE_CURL_CFFI, PovarenokClient
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Парсер рецептов povarenok.ru")
...
def main() -> None:
    ...
    if args.command == "retry":
        print(retry_failed_categories(client, categories_path, ids_path, previews_path, failed_categories_path))
        return
